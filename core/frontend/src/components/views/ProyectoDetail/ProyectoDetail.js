  ...
  return(
    <div className="container px-4 py-5">
      <div className="row align-items-center">
        <Header>{ proyectoData.title }</Header>
        <Date>{proyectoData.date}</Date>
      </div>

      <div className="container pt-4 pb-5 px-3 border-top">
        <Content>
          {proyectoData.description}
        </Content>
      </div>

    <div className="container d-flex justify-content-center">
        <img className="img-fluid" src={"https://res.cloudinary.com/aprenderhaciendo/" + proyectoData.imagen}></img>
    </div>
