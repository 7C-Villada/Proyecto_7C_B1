...
const QueHacemos = () => {
  return (
    <div className="container pt-3">
      <div className="container px-4 pt-5" id="custom-cards" id={"que_hacemos"}>
            ...
            <Card>
              <div className="tile d-flex flex-column h-100 text-white text-shadow-1">
                ...
                <div className="text">
                  ...
                  <Content>
                    Conocer los recursos naturales. Entender los procesos del
                    ambiente. Aprender sobre bosque nativo.
                  </Content>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="tile d-flex flex-column h-100 text-white text-shadow-1">
                ...
                <div className="text">
                  ...
                  <Content>
                    Identificar los recursos disponibles. Respetar la
                    naturaleza. Reconocer el bosque de nuestra región.
                  </Content>
                </div>
              </div>
            </Card>
            ...
            <Card>
              <div className="tile d-flex flex-column h-100 text-white text-shadow-1">
                ...
                <div className="text">
                  ...
                  <Content>
                    Utilizar racionalmente los recursos. Vivir en armonía con el
                    ambiente. Restaurar el bosque y vivir en equilibrio con él.
                  </Content>
                </div>
              </div>
            </Card>
